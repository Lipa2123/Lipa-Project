	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				< p style="font-size:20px">Agro Culture Farm<span>Banpur</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">8658690749</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">lipadas4567@gmail.com</a></p>
			</div>
		</div>
